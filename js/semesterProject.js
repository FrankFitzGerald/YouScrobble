		...
		$.ajax({
			...
			success: function(data){
			  ...
			  for (var i = 0; i < items.length; i++) {
			    ...
			    console.log(item);
			    var content = '<object width="560" height="315"><param name="movie" value='+item+'></param><param name="allowFullScreen" value="true"></param><param name="allowscriptaccess" value="always"></param><embed src='+entry+' type="application/x-shockwave-flash" width="560" height="315" allowscriptaccess="always" allowfullscreen="true"></embed></object>';
